...
requirements = python3,kivy==2.0.0rc1,requests,certifi,urllib3,chardet,idna,plyer,timezonefinderl,oscpy,mapview,https://github.com/kivymd/KivyMD/archive/master.zip,pillow
