...
requirements = python3,kivy==2.0.0,requests,certifi,urllib3,chardet,idna,plyer,timezonefinder,oscpy,mapview,https://github.com/kivymd/KivyMD/archive/master.zip,pillow,pytz
